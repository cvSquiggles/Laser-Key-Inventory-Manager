    ...
    try:
        ...
        while confirmed != "yes":
            ...
            if confirmed == "yes":
                ...
                c2 = db.cursor()
                c2.execute("INSERT INTO resupplyTEST (submit_time, keyNum, keysAdded, preCount, postCount) VALUES (?, ?, ?, ?, ?)", (u_date, u_keyNum, u_keysAdded, u_preCount, u_postCount))
                c2.commit()
